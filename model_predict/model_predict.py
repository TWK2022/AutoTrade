...
parser.add_argument('--industry_screen', default='dataset/industry_screen.yaml', type=str, help='|待预测股票|')
parser.add_argument('--result_save_path', default='dataset/model_predict.yaml', type=str, help='|保存结果|')
parser.add_argument('--data_dir', default='dataset/stock_add', type=str, help='|股票数据|')
parser.add_argument('--save_dir', default='model_predict/weight', type=str, help='|保存模型|')
...
parser.add_argument('--input_column', default='model_predict/input_column.txt', type=str, help='|输入变量，可传入.txt|')
parser.add_argument('--output_column', default='model_predict/output_column.txt', type=str, help='|预测变量，可传入.txt|')
...
parser.add_argument('--save_path', default='model_predict/last.pt', type=str, help='|保存模型|')
parser.add_argument('--save_best', default='model_predict/best.pt', type=str, help='|保存最佳模型|')
...
args.result_save_path = project_dir + '/' + args.result_save_path
...
class model_predict_class:
    ...
    def predict(self):
        ...
        print(f'| 保存结果：{self.result_save_path} |')


# -------------------------------------------------------------------------------------------------------------------- #
if __name__ == '__main__':
    model = model_predict_class()
    model.model_predict()
